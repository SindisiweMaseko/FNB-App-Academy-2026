"""
lesson_03:
Description: A script covering string indexing, string methods like upper() and strip(),
             and generating a professional system email using user input and f-strings.
"""
#Adding two numbers
#Strings
